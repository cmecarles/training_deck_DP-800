...
- Functional group: Manage and optimize database performance and data integration (15–20%); also Configure and secure the database engine (15–20%).
- Skill: Integrate an Azure SQL Database with Microsoft Fabric.
