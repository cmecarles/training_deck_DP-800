...
- Functional group: Design and develop database solutions (35–40%); also Manage and optimize database performance and data integration (15–20%).
- Skill: Query and integrate data across Fabric items.
